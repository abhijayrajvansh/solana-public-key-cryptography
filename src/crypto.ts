...
import { stringToUint8Array, uint8ArrayToString } from "./types-conversion";
...
console.log("private key:", uint8ArrayToString(privateKey));
console.log("publicKey:", uint8ArrayToString(publicKey));
